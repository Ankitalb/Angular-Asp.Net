...
namespace MachineTestWebAPI.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(MT_PL1924Context context)
        {
            _context = context;
        }
        ...
        {
            var list = _context.Employee.Select(e => new
            {
                id = e.EmpId,
                name = e.FirstName
            });
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Employee>> DeleteEmployee(decimal id)
        {
            var employee = await _context.Employee.FindAsync(id);
            if (employee == null)
            {
